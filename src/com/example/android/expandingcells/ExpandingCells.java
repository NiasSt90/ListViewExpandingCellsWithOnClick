...
public class ExpandingCells extends Activity {
	...
	private final int NUM_OF_CELLS = 300;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for (int i = 0; i < NUM_OF_CELLS; i++) {
			...
			mData
				.add(new ExpandableListItem(obj.getTitle(), obj.getImgResource(), obj.getCollapsedHeight(), obj.getText()));
		}


		mListView = (ExpandingListView) findViewById(R.id.main_list_view);
		CustomArrayAdapter adapter = new CustomArrayAdapter(this, R.layout.list_view_item, mData, mListView);
